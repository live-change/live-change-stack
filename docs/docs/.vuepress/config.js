  ...
  theme: defaultTheme({
    ...
    sidebar: {
      '/server/': [
        ...
        { text: '05a Property validation', link: '/server/05a-validation.md' },
        ...
        { text: '  09-00 Generated artifacts (relations-plugin)', link: '/server/09-00-relations-generated-artifacts.md' },
        ...
        { text: '  09-07 Owner selection & userItem', link: '/server/09-07-owner-selection-useritem.md' },
