...
const { currencyZero = 0, currencyAdd = (...args) => {
    return args.reduce((a, b) => a + b, 0);
}, currencyNegate = (value) => -value, currencyIsPositive = (value) => value > 0, changePossible = (value, change) => {
...
readerRoles = ['owner', 'admin'], createBalanceIfNotExists = true, } = definition.config;
const { currencyType = {
    type: Number,
