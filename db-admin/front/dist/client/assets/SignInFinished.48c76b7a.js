...
const _hoisted_2 = /* @__PURE__ */ createBaseVNode("div", { class: "surface-card border-round shadow-2 p-4" }, [
  /* @__PURE__ */ createBaseVNode("div", { class: "text-900 font-medium mb-3 text-xl mb-4" }, "Signed In"),
  /* @__PURE__ */ createBaseVNode("p", { class: "mt-0 p-0 line-height-3" }, "Congratulations! You have successfully logged in to your account.")
], -1);
const _hoisted_3 = [
  _hoisted_2
];
...
var SignInFinished = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export default SignInFinished;
