...
test("store count observable", t => {
  ...
  t.test("observe count [a,z]", async t => {
    ...
    t.test("remove object 'a' from observed count", queued(async t => {
      t.plan(1)
    ...
    t.test("add object 'a' to observed count", queued(async t => {
      t.plan(1)
    ...
    t.test("add object 'b' to observed count", queued(async t => {
      t.plan(1)
    ...
    t.test("add object 'd' to observed count", queued(async t => {
      t.plan(1)
    ...
    t.test("unobserve count", queued(async t => {
      t.plan(1)
  ...
  t.test("observe count (a,d)", async t => {
    ...
    t.test("remove object 'd' outside observed count", queued(async t => {
      t.plan(1)
      await store.delete('d')
      t.pass('deleted')
    }))

    t.test("remove object 'a' outside observed count", queued(async t => {
      t.plan(1)
      await store.delete('a')
      t.pass('deleted')
    }))

    t.test("add object 'ab' to observed count", queued(async t => {
      t.plan(1)
    ...
    t.test("remove object 'ab' from observed count", queued(async t => {
      t.plan(1)
